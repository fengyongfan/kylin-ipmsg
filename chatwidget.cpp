...
void ChatWidget::firstStyle(){
    ...
    if(this->dbuddy->ip() == "IP MAC"){
        ...
        if(this->ui->lb_name->text() == "? ? ?"){
            this->ui->lb_name->setText(this->ip);
        }
    }
...
//    this->setWindowTitle("麒麟传书" + this->ip);
    ...
    this->ui->lb_name->setStyleSheet("QLabel{color: " + this->theme->color4() + ";}");
    this->ui->lb_machine->setStyleSheet("QLabel{color: " + this->theme->color4() + ";}");
...
void ChatWidget::showme(){
    ...
    this->ui->lb_title->setStyleSheet("QLabel{color: " + this->theme->color2() + ";}");
    this->ui->le_ip->setStyleSheet("QLineEdit{color: " + this->theme->color4() + "; border: 1px solid " + this->theme->color3() + ";}");
    this->ui->te_chatlog->setStyleSheet("QTextBrowser{border: " + this->theme->color3() + ";}");
    this->ui->te_chat->setStyleSheet("QTextEdit{border: 1px solid " + this->theme->color3() + ";}");
    this->ui->pb_sendmsg->setStyleSheet("QPushButton{border: 2px solid " + this->theme->color2() + "; color: "+this->theme->color2()+";}");
    this->ui->pb_sendfile->setStyleSheet("QPushButton{border: 2px solid " + this->theme->color2() + "; color: "+this->theme->color2()+";}");
    this->ui->pb_senddir->setStyleSheet("QPushButton{border: 2px solid " + this->theme->color2() + "; color: "+this->theme->color2()+";}");
    this->ui->lb_head_bg->setStyleSheet("QLabel{background-color: " + this->theme->color3() + "}");

    this->ui->lb_w_title->setStyleSheet("QLabel{color: " + this->theme->color6() + ";}");
    this->ui->lb_w_text->setStyleSheet("QLabel{color: " + this->theme->color6() + ";}");
    this->ui->pb_w_cancel->setStyleSheet("QPushButton{border: 2px solid " + this->theme->color6() + "; color: " + this->theme->color6() + ";}");
    ...
    this->ui->lb_w_title_recv->setStyleSheet("QLabel{color: " + this->theme->color6() + ";}");
    this->ui->lb_w_text_recv->setStyleSheet("QLabel{color: " + this->theme->color6() + ";}");
    ...
    this->ui->lb_alert->setStyleSheet("QLabel{color: " + this->theme->color6() + ";}");

    // coaliang
    this->ui->pb_addname->setStyleSheet("QPushButton{border: 2px solid " + this->theme->color2() + "; color: "+this->theme->color2()+";}");
    this->ui->le_nickname->setStyleSheet("QLineEdit{color: " + this->theme->color4() + "; border: 1px solid " + this->theme->color3() + ";}");
    this->ui->pb_checkname->setStyleSheet("QPushButton{border: 2px solid " + this->theme->color2() + "; color: "+this->theme->color2()+";}");
