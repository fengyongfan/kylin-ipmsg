...
Item {
    ...
    signal showText();
    signal componentClicked(string mac);
...
//        text: ":-("
    ...
    SText  {
        ...
        font.pixelSize: 17
        color: theme.color4
        text: qsTr("Sorry, there is nothing yet...")
        visible: (recentList.count == 0)
    }
        ...
        Component {
             ...
             Item {
                 ...
                 MouseArea {
                     ...
                     hoverEnabled: true
                     onClicked: {
                        guiBehind.showSendPage(mac);
                        emit: componentClicked(mac);
                     }
                 }
